...
if(isset($_POST['form_add_to_cart'])) {
    ...
    if(isset($_SESSION['cart_p_id']))
    {
        ...
        if($added == 1) {
           $error_message1 = 'This product is already added to the shopping cart.';
            ...
            $_SESSION['cart_p_price'][$new_key] = $_POST['p_price'];
    ...
    else
    {
        ...
        $_SESSION['cart_p_price'][1] = $_POST['p_price'];
					...
					<div class="row">
						...
						<div class="col-md-7">
							...
							<div class="p-price">
                                ...
                                <span>
                                    <?php echo LANG_VALUE_1; ?><?php echo $p_price; ?>
                                </span>
                            </div>
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <h4>
                                    <?php echo LANG_VALUE_1; ?><?php echo $row['p_price']; ?> 
                                </h4>
                                <div class="rating">
                                    <?php
                                    $t_rating = 0;
