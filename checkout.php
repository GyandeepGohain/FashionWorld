    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                if (!$billing_shipping_complete) {
                    echo '<script>window.location.href="customer-billing-shipping-update.php";</script>';
                    exit;
                }
                ...
                <div class="cart">
                    <table class="table table-responsive">
                        ...
                        <tr>
                            ...
                            <td><?php echo LANG_VALUE_1; ?><?php echo $arr_cart_p_price[$i]; ?></td>
                            <td><?php echo $arr_cart_p_qty[$i]; ?></td>
                            <td class="text-right">
                                <?php
                                $row_total_price = (float)$arr_cart_p_price[$i]*(int)$arr_cart_p_qty[$i];
                    ...
                    <ul>
                        ...
                        <li>
                            <form action="payment.php" method="post">
                                ...
                                <input type="submit" class="btn btn-primary" value="Proceed to Checkout" name="form_proceed">
                            </form>
                        </li>
                    </ul>
                </div>
